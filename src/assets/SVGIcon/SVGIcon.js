...
const getViewBox = (name) => {
    switch (name) {
        ...
        case 'icon-triangle-left':
            return '0 0 20 20';
        case 'icon-triangle-right':
            return '0 0 20 20';
        case 'icon-check':
            return '0 0 20 20';
        case 'icon-circle-with-cross':
            return '0 0 20 20';
...
const getPath = (name, props) => {
    switch (name) {
        ...
        case 'icon-triangle-left':
            return <path {...props} d="M14 5v10l-9-5 9-5z" />;
        case 'icon-triangle-right':
            return <path {...props} d="M15 10l-9 5v-10l9 5z" />;
        case 'icon-check':
            return (
                <path
                    {...props}
